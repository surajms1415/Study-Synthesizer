    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-500/30">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-32 text-center">
        ...
        <div className="flex justify-center mb-16">
          <a href="https://github.com/surajms1415/Study-Synthesizer/releases/download/v1.0.0/StudySynthesizer.Setup.1.0.0.exe.exe" className="flex items-center space-x-2 bg-indigo-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-indigo-700 hover:scale-105 transition-all shadow-xl shadow-indigo-600/30">
